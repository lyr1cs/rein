...
| Feature | Description |
|---------|-------------|
| **35 MCP tools** | 8 core memory + 9 maintenance (incl. v0.23 `rein_resummerize`) + 10 knowledge graph + 2 temporal + 2 adaptive + 1 session ingest + 2 ARS concept-summary (v0.24) + 1 http_token |
