...
```bash
cargo install --git https://github.com/lyr1cs/rein --tag v0.28.18 --locked rein --force
```
...
```bash
git clone --branch v0.28.18 https://github.com/lyr1cs/rein
cd rein
...
1. **Claude Code plugin marketplace** — see the project README's
   ...
   `cargo install --git https://github.com/lyr1cs/rein --tag v0.28.18 --locked rein` separately.
