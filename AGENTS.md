...
- **Deferred**: production activation of accelerated fusion, non-shadow mode, and any default-on ARS acceleration remain out of scope for a later release after canary data and review.
